...
void *hl_alloc(void *heap, unsigned int block_size) {
  ...
  // {
  //   // free_space_after = next_block->next_block - (void*) (ADD_BYTES(next_block,total_block_size));
  // }
  // else
  // {
  //   free_space_after =(void*) (next_block+ next_block->block_size) - (void*) (ADD_BYTES(next_block,total_block_size));
  // }
  //^how much space is left after allocating the block
